...
Автор Балашов В.О.
Дата последней правки 06.08.2022
Версия 1.2
*/
...
void window_setting(void)
{
	switch(count_windows)
	{
		...
		"кнопками и таблицей нажимайте Tab.";
...
//                  Проверка итогового пользовательского ввода
//---------------------------------------------------------------------------
...
void __fastcall TWindow::TableKeyPress(TObject *Sender, System::WideChar &Key)
{
	...
	{   // Фиксация удаления последнего символа ячейки
...
//     Сброс cells_strings, флагов наличия запятых и цифр в ячейках Table
//---------------------------------------------------------------------------
void reset_flags()
{
	for(int i = 0; i < 3; i++)
